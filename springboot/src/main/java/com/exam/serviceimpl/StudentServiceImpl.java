...
public class StudentServiceImpl implements StudentService {
    ...
    @Override
    public int updateStudent(String sname,String semail ,String ssex, String ins, String spwd, String card, String tel, String oringalEmail) {
        return studentMapper.updateStudent(sname,semail ,ssex,ins, spwd,card,tel,oringalEmail);
    }
